  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-24">
        ...
        >
          <h2 className="text-3xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <motion.form
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white md:p-10 p-5 rounded-3xl shadow-xl border border-gray-100"
          >
