  ...
  return (
    <div className="home__data">
        ...
        <p className="home__description">
            Versatile and results-driven Full-Stack Developer with a 
            proven track record in designing and deploying high-performance 
            web and mobile applications. Skilled in both frontend and backend 
            technologies, including React, Next.js, Node.js, Express, Python 
            and Django, along with mobile development in React Native and Expo. 
            Experienced in microservices architecture, DevOps practices, and 
            containerization with Docker and Kubernetes to ensure scalable, 
            maintainable solutions. As a team lead, I bring strong problem-solving 
            skills, effective collaboration, and a passion for innovation. 
            Dedicated to delivering seamless, user-focused applications that 
            exceed business goals and enhance user experience.
        </p>
